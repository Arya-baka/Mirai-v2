...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "hi.gif")) request("https://i.pinimg.com/originals/1a/e4/01/1ae40103c3aa1afcf8b637fbd9c7e8c6.gif").pipe(fs.createWriteStream(dirMaterial + "hi.gif"));
}
