...
var coinsdv = Math.floor(Math.random() * 1100) + 1000; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 1200) + 1000; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 1100) + 1000; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 1000) + 1000; //random coins khi đào đá
var coinsdd1 = Math.floor(Math.random() * 1023) + 1000; //random coins khi đào đá
